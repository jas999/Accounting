...
public class UserController {
	...
	public Map<String,Object> updateUserProfile(HttpServletResponse response,@RequestBody User user) {
		...
		/*user.setNewsLetterSubscribed(user.isNewsLetterSubscribed() !=null ? user.isNewsLetterSubscribed() : false);
		user.setNotificationOn(isNotificationOn);
		user.setAccomodationTaken(isAccomodationTaken);
		user.setMealTaken(isMealTaken);
		user.setJobsOn(isJobsOn);
		user.setCoachingAdsOn(isCoachingAdsOn);*/
		user = userService.saveUser(user);
