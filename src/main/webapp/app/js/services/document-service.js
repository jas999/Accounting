angular.module("accounting").service('DocumentService', function($q, $http){
	...
	var findAllDocuments = function(qry){
	  ...
	  var findAllDocumentsByTitleAndServiceSelected = function(qry){
		    return $q(function(resolve, reject) {
		    	var documentsAPI = '/find/documents/ByTitleAndServiceSelected'+qry;
			      $http.get(documentsAPI).then(function(resp){
			        resolve(resp);
			      }, function(error){
			        console.log(error)
	  ...
	  var findAllDocumentsByServiceSelected = function(qry){

		    return $q(function(resolve, reject) {
		    	var documentsAPI = '/find/documentsByServiceSelected'+qry;
			      $http.get(documentsAPI).then(function(resp){
			        resolve(resp);
			      }, function(error){
			        console.log(error)
	  ...
	  return {
		  ...
		  findAllDocumentsByServiceSelected:findAllDocumentsByServiceSelected,
		  findAllDocumentsByTitleAndServiceSelected:findAllDocumentsByTitleAndServiceSelected
	  }
});